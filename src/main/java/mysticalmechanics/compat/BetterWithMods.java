...
public class BetterWithMods {
    ...
    public void registerBlocks(RegistryEvent.Register<Block> event) {
        CONVERTER_BWM = (BlockConverterBWM) new BlockConverterBWM(Material.WOOD).setRegistryName(MysticalMechanics.MODID, "converter_bwm").setUnlocalizedName("converter_bwm").setItemGroup(MysticalMechanics.itemGroup).setHardness(5.0F).setResistance(10.0F);
    ...
    public void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().register(new BlockItem(CONVERTER_BWM).setRegistryName(CONVERTER_BWM.getRegistryName()));
    }
